...
def ui():
	...
	while(q == 0):
		...
		################################
			...
			if PN.grabber_status=="open":
				print("Closing Grabber")
				PN.closeGrabber()
			elif PN.grabber_status=="closed":
...
class pneumatics:
	...
	## Universal Methods ##
	#######################
	#method for reseting the config
	def reset(self):
	...
	def closeGrabber(self):
		...
		self.grabber_status = "closed"

	def openGrabber(self):
		self.grabber.writeToPort(0)
		self.grabber_status = "open"
